...
class Qcld_Bargain_Admin_Area_Controller {
	...
	function __construct(){
		...
		add_action( 'plugins_loaded', [$this, 'qcld_bargain_load_textdomain'] );
	}


	public function qcld_bargain_load_textdomain() {
	    load_plugin_textdomain( 'woo-minimum-acceptable-price', false, dirname( plugin_basename( __FILE__ ) ) . '/lang/' );
	}
	...
	public function qcld_bargain_register_plugin_settings(){
		...
		register_setting( 'qc-wppt-map-plugin-settings-group', 'qcld_minimum_accept_button_text_color', $args );
		register_setting( 'qc-wppt-map-plugin-settings-group', 'qcld_minimum_accept_button_bg_text_color', $args );
		register_setting( 'qc-wppt-map-plugin-settings-group', 'qcld_minimum_accept_button_bg_hover_color', $args );
		register_setting( 'qc-wppt-map-plugin-settings-group', 'qcld_minimum_accept_submit_btn_text_color', $args );
		register_setting( 'qc-wppt-map-plugin-settings-group', 'qcld_minimum_accept_submit_btn_bg_color', $args );
		register_setting( 'qc-wppt-map-plugin-settings-group', 'qcld_minimum_accept_submit_btn_hover_bg_color', $args );
	...
	<div class="wrap swpm-admin-menu-wrap" id="tabs">
		...
		<ul class="nav-tab-wrapper bargain_nav_container">
			...
			<li style="margin-bottom:0px"><a class="nav-tab bargain_click_handle" href="#tab-2"><?php esc_html_e('Style','woo-minimum-acceptable-price') ?></a></li>
			<li style="margin-bottom:0px"><a class="nav-tab bargain_click_handle" href="#tab-3"><?php esc_html_e('Exit Intent','woo-minimum-acceptable-price') ?></a></li>
			<li style="margin-bottom:0px"><a class="nav-tab bargain_click_handle" href="#tab-4"><?php esc_html_e('Email Settings','woo-minimum-acceptable-price') ?></a></li>
			<li style="margin-bottom:0px"><a class="nav-tab bargain_click_handle" href="#tab-5"><?php esc_html_e('Help','woo-minimum-acceptable-price') ?></a></li>
		</ul>
		...
		<form method="post" action="options.php">
			...
			<div id="tab-2">
				<table class="form-table">
					...
					<tr valign="top">
						<th scope="row"><?php esc_html_e('Make Your Offer Now Button Text Color','woo-minimum-acceptable-price') ?></th>
						<td>
							<input type="text" name="qcld_minimum_accept_button_text_color" class="bargain-bg-color" size="100" value="<?php echo (get_option('qcld_minimum_accept_button_text_color')!=''?esc_attr( get_option('qcld_minimum_accept_button_text_color')):""); ?>"  />
							<br><br><i><?php esc_html_e('You can change the Make Your Offer Now Button Text Color, leave empty for default color','woo-minimum-acceptable-price') ?> </i>
						</td>
					</tr>
					<tr valign="top">
						<th scope="row"><?php esc_html_e('Make Your Offer Now Button Background Color','woo-minimum-acceptable-price') ?></th>
						<td>
							<input type="text" name="qcld_minimum_accept_button_bg_text_color" class="bargain-bg-color" size="100" value="<?php echo (get_option('qcld_minimum_accept_button_bg_text_color')!=''?esc_attr( get_option('qcld_minimum_accept_button_bg_text_color')):""); ?>"  />
							<br><br><i><?php esc_html_e('You can change the Make Your Offer Now Button Background Color, leave empty for default color','woo-minimum-acceptable-price') ?> </i>
						</td>
					</tr>
					<tr valign="top">
						<th scope="row"><?php esc_html_e('Make Your Offer Now Button Hover Background Color','woo-minimum-acceptable-price') ?></th>
						<td>
							<input type="text" name="qcld_minimum_accept_button_bg_hover_color" class="bargain-bg-color" size="100" value="<?php echo (get_option('qcld_minimum_accept_button_bg_hover_color')!=''?esc_attr( get_option('qcld_minimum_accept_button_bg_hover_color')):""); ?>"  />
							<br><br><i><?php esc_html_e('You can change the Make Your Offer Now Button Hover Background Color, leave empty for default color','woo-minimum-acceptable-price') ?> </i>
						</td>
					</tr>
					<tr valign="top">
						<th scope="row"><?php esc_html_e('Submit Button Text Color','woo-minimum-acceptable-price') ?></th>
						<td>
							<input type="text" name="qcld_minimum_accept_submit_btn_text_color" class="bargain-bg-color" size="100" value="<?php echo (get_option('qcld_minimum_accept_submit_btn_text_color')!=''?esc_attr( get_option('qcld_minimum_accept_submit_btn_text_color')):""); ?>"  />
							<br><br><i><?php esc_html_e('You can change the Submit Button Text Color, leave empty for default color','woo-minimum-acceptable-price') ?> </i>
						</td>
					</tr>
					<tr valign="top">
						<th scope="row"><?php esc_html_e('Submit Button Background Color','woo-minimum-acceptable-price') ?></th>
						<td>
							<input type="text" name="qcld_minimum_accept_submit_btn_bg_color" class="bargain-bg-color" size="100" value="<?php echo (get_option('qcld_minimum_accept_submit_btn_bg_color')!=''?esc_attr( get_option('qcld_minimum_accept_submit_btn_bg_color')):""); ?>"  />
							<br><br><i><?php esc_html_e('You can change the Submit Button Background Color, leave empty for default color','woo-minimum-acceptable-price') ?> </i>
						</td>
					</tr>
					<tr valign="top">
						<th scope="row"><?php esc_html_e('Submit Button Hover Background Color','woo-minimum-acceptable-price') ?></th>
						<td>
							<input type="text" name="qcld_minimum_accept_submit_btn_hover_bg_color" class="bargain-bg-color" size="100" value="<?php echo (get_option('qcld_minimum_accept_submit_btn_hover_bg_color')!=''?esc_attr( get_option('qcld_minimum_accept_submit_btn_hover_bg_color')):""); ?>"  />
							<br><br><i><?php esc_html_e('You can change the Submit Button Hover Background Color, leave empty for default color','woo-minimum-acceptable-price') ?> </i>
						</td>
					</tr>
    ...
    <div id="message-bargain" class="notice notice-info is-dismissible" style="padding:4px 0px 0px 4px;background:#C13825;">
        <?php
            printf(
                ...
                '<img src="'.esc_url(QCLD_MAP_EXTENDED_IMG_URL).'eid-24.gif" >',
                '</a>'
            );
        ?>
    </div>
