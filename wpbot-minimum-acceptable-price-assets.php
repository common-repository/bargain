...
function qcld_bargain_load_front_scripts(){
    ...
    $custom_css = '';
    $qcld_minimum_accept_button_text_color      = get_option('qcld_minimum_accept_button_text_color');
    $qcld_minimum_accept_button_bg_text_color   = get_option('qcld_minimum_accept_button_bg_text_color');
    $qcld_minimum_accept_button_bg_hover_color  = get_option('qcld_minimum_accept_button_bg_hover_color');
    $qcld_minimum_accept_submit_btn_text_color  = get_option('qcld_minimum_accept_submit_btn_text_color');
    $qcld_minimum_accept_submit_btn_bg_color    = get_option('qcld_minimum_accept_submit_btn_bg_color');
    $qcld_minimum_accept_submit_btn_hover_bg_color= get_option('qcld_minimum_accept_submit_btn_hover_bg_color');
    
    if(!empty( $qcld_minimum_accept_button_text_color)){
        
        $custom_css .= 'body .woo_minimum_accept_price-field-wrapper #woo_minimum_accept_price-field {
                    color: '.$qcld_minimum_accept_button_text_color.';
                }';
    }

    if(!empty( $qcld_minimum_accept_button_bg_text_color)){
        
        $custom_css .= 'body .woo_minimum_accept_price-field-wrapper #woo_minimum_accept_price-field {
                    background: '.$qcld_minimum_accept_button_bg_text_color.';
                    border: 1px solid '.$qcld_minimum_accept_button_bg_text_color.';
                }';
    }

    if(!empty( $qcld_minimum_accept_button_bg_hover_color)){

        $custom_css .= 'body .woo_minimum_accept_price-field-wrapper #woo_minimum_accept_price-field:hover {
                        background: '.$qcld_minimum_accept_button_bg_hover_color.';
                        border: 1px solid '.$qcld_minimum_accept_button_bg_hover_color.';
                    }';
    }
    
    if(!empty( $qcld_minimum_accept_submit_btn_text_color)){
        $custom_css .= 'body .woo-chatbot-products-bargain-modal .woo-chatbot-products-bargain-info button.woo-chatbot-product-bargain-submit, body .woo-chatbot-products-bargain-modal .woo-chatbot-products-bargain-info button.woo-chatbot-product-bargain-variation-submit, body .woo-chatbot-products-bargain-modal .woo-chatbot-products-bargain-info button.woo-modal-product-bargain-price-submit, body .woo-chatbot-products-bargain-modal .woo-chatbot-products-bargain-info button.woo-modal-product-bargain-email-submit{
            color: '.$qcld_minimum_accept_submit_btn_text_color.';
        }';

    }
    
    if(!empty( $qcld_minimum_accept_submit_btn_bg_color)){
        $custom_css .= 'body .woo-chatbot-products-bargain-modal .woo-chatbot-products-bargain-info button.woo-chatbot-product-bargain-submit, body .woo-chatbot-products-bargain-modal .woo-chatbot-products-bargain-info button.woo-chatbot-product-bargain-variation-submit, body .woo-chatbot-products-bargain-modal .woo-chatbot-products-bargain-info button.woo-modal-product-bargain-price-submit, body .woo-chatbot-products-bargain-modal .woo-chatbot-products-bargain-info button.woo-modal-product-bargain-email-submit{
            border: 1px solid '.$qcld_minimum_accept_submit_btn_bg_color.';
            background: '.$qcld_minimum_accept_submit_btn_bg_color.' !important;
        }';

    }
    
    if(!empty( $qcld_minimum_accept_submit_btn_hover_bg_color)){
        $custom_css .= ' body .woo-chatbot-products-bargain-modal .woo-chatbot-products-bargain-info button.woo-chatbot-product-bargain-submit:hover, body .woo-chatbot-products-bargain-modal .woo-chatbot-products-bargain-info button.woo-chatbot-product-bargain-variation-submit:hover, body .woo-chatbot-products-bargain-modal .woo-chatbot-products-bargain-info button.woo-modal-product-bargain-price-submit:hover, body .woo-chatbot-products-bargain-modal .woo-chatbot-products-bargain-info button.woo-modal-product-bargain-email-submit:hover, body .woo-chatbot-products-bargain-modal .woo-chatbot-products-bargain-info button:hover {
            border: 1px solid '.$qcld_minimum_accept_submit_btn_hover_bg_color.';
            background: '.$qcld_minimum_accept_submit_btn_hover_bg_color.' !important;
        }';
    }

    wp_add_inline_style( 'qcld_bargain_front_custom_css', $custom_css );
